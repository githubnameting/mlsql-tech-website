...
'user.nickname': "昵称",
'user.phone_number': "电话号码",
'user.company': "公司名称",
'user.email.required': '邮箱不能为空',
'user.password.required': '密码不能为空',
'user.password_confirm.required': '两次输入的密码不匹配!',
'user.nickname.required': '昵称不能为空',
'user.phone_number.required': '电话号码不能为空',
'user.email.valid': '邮箱不合法!',
'user.company.required': '公司名称不能为空'
}
